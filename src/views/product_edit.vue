<template>
      ...
      <tbody>
        <tr v-for="product in products" :key="product.product_id">
          ...
          <td>
            <img
              v-if="product.image"
              :src="'http://localhost/project-67706177/api_php/uploads/' + product.image"
              width="100"
            />
          </td>
          <td>
  ...
  <div v-if="isEditMode && editForm.image">
    ...
    <img
      :src="'http://localhost/project-67706177/api_php/uploads/' + editForm.image"
      width="100"
    />
  </div>
</div>
...
export default {
  ...
  setup() {
    ...
    const fetchProducts = async () => {
      try {
        const res = await fetch("http://localhost/project-67706177/api_php/api_product.php");
